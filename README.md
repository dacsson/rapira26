...
Если вам интересна производительность языка, самые свежие данные находятся [тут](benchmarks/PERF_STATUS.md) (в сравнении с питоном).

## Примеры кода

На данный момент примеры кода можешь посмотреть в `/examples` или в [песочнице](https://dacsson.github.io/rapira26-playground/), но когда-нибудь я сделаю тур, обещаю...
